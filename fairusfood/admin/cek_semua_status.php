<?php
// PERBAIKAN: Tambahkan session_start() di baris paling atas
session_start();
require 'koneksi.php'; // Sesuaikan path jika koneksi.php ada di direktori yang sama
...
// Diubah untuk menerima objek dengan key 'ids'
...
// Mengirim ID terbaru dan juga status terupdate
echo json_encode([
